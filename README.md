                                           # Module21_  Deep-Learning-Challenge

Dissimilar: For sample codes and results of analysis, please refer the PDF file that contains the analysis report. This readme file has general information regarding background information, steps to follow, and other instructions. 

This module was designed to help students (us) apply what we have learned regarding predicting outcomes using machine learning algorithm. In this module, the non-profit foundation Alphabet Soup wants to create an algorithm to predict whether applicants for funding will be successful. With your knowledge of machine learning and neural networks, you’ll use the features in the provided dataset to create a binary classifier that can predict whether applicants will be successful if funded by Alphabet Soup.
Below is a summary of the steps to follow, questions to answer, and what is expected at the end.  
